    ...
    public class Program
    {
        ...
        TOP:
            ...
            switch (input1)
            {
                ...
                TOP2:
                    FileStream fileStreamobj = new FileStream(@"D:\C#handson\Librarians.txt", FileMode.Open, FileAccess.Read);
                ...
                bTOP2:
                    FileStream bfileStreamobj = new FileStream(@"D:\C#handson\Borrowers.txt", FileMode.Open, FileAccess.Read);
