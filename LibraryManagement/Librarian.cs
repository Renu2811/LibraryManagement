...
namespace LibraryManagement
{
    public class Librarian
    {
        ...
        TOP:
            ...
            {
                case 1:
                    if (File.Exists(@"D:\C#handson\IssuedBooksDetail.txt") == true)
                    {
                        Console.WriteLine("BID BookName Author IssueDate ReturnDate");
                        FileStream fileStreamobj = new FileStream(@"D:\C#handson\IssuedBooksDetail.txt", FileMode.Open, FileAccess.Read);
                    ...
                    break;
                case 2:
                    if (File.Exists(@"D:\C#handson\BooksInLibrary.txt") == true)
                    {
                    TOP1:
                        int checkCount = 0;
                        ...
                        FileStream forCheck = new FileStream(@"D:\C#handson\BooksInLibrary.txt", FileMode.Open, FileAccess.Read);
                        ...
                        {
                            FileStream fileStreamobj1 = new FileStream(@"D:\C#handson\IssuedBooksDetail.txt", FileMode.Append, FileAccess.Write);
                ...
                case 3:
                    ...
                    {
                        string temp2;
                        FileStream fileStreamobj2 = new FileStream(@"D:\C#handson\IssuedBooksDetail.txt", FileMode.Open, FileAccess.Read);
                        ...
                        FileStream newobj = new FileStream(@"D:\C#handson\IssuedBooksDetail1.txt", FileMode.Create, FileAccess.Write);
                        ...
                        newobj2.Close();
                        newobj.Close();
                        File.Delete(@"D:\C#handson\IssuedBooksDetail.txt");
                        File.Move(@"D:\C#handson\IssuedBooksDetail1.txt", @"D:\C#handson\IssuedBooksDetail.txt");
                    }
                    else
                    {
                        Console.WriteLine("No books issued till now");
                ...
                WRONGINPUT:
                    ...
                    {
                        case 1:
                            if (File.Exists(@"D:\C#handson\BooksInLibrary.txt") == false)
                            {
                            ...
                            else
                            {
                                ...
                                FileStream objForBookDetail = new FileStream(@"D:\C#handson\BooksInLibrary.txt", FileMode.Open, FileAccess.Read);
                            ...
                            break;
                        case 2:
                            FileStream objForBookDetail1 = new FileStream(@"D:\C#handson\BooksInLibrary.txt", FileMode.Append, FileAccess.Write);
